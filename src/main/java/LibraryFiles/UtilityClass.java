...
public class UtilityClass 
{
	...
	{
		FileInputStream file=new FileInputStream(System.getProperty("user.dir") +"\\TestData\\3rdFebSelenium.xlsx");
	...
	public static void captureSS(WebDriver driver,int TCID) throws IOException 
	{
		...
		File dest=new File(System.getProperty("user.dir")+"\\FailedTCesSS\\TestCase" +TCID+ ".jpg");
